          ...
          <div className="px-5 lg:px-16 xl:px-20">
            <div className="rounded-lg overflow-hidden bg-gray-500/10 mb-4">
              <Image
                src={
                  productData?.image?.[0] ||
                  "https://images.pexels.com/photos/6864685/pexels-photo-6864685.jpeg"
                }
                alt="alt"
                className="w-full h-80 object-cover mix-blend-multiply"
                width={1280}
                height={720}
              />
            </div>
            ...
            <div className="grid grid-cols-4 gap-4">
              {productsDummyData[0]?.image?.map((image, index) => (
                <div
                  key={index}
          ...
          <div className="flex flex-col">
            ...
            <div className="flex items-center mt-10 gap-4">
              ...
              <button
                ...
                className="w-full py-3.5 bg-pink-500 text-white hover:bg-pink-400 transition"
              >
                Buy now
              </button>
            </div>
